:: I. System Structure ::
:: inner.hoon is the core stateful logic of the dumbnet blockchain kernel. It orchestrates the receipt, validation, and storage of blocks and transactions, including genesis block handling, block propagation, consensus tracking, and transaction gossip. ::

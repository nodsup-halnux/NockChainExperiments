...
const INITIAL_PEER_RETRIES: u32 = 8;
...
const MAX_ESTABLISHED_INCOMING_CONNECTIONS: u32 = 20;

/** Maximum number of established *incoming* connections */
const MAX_ESTABLISHED_OUTGOING_CONNECTIONS: u32 = 40;

/** Maximum number of established connections */
const MAX_ESTABLISHED_CONNECTIONS: u32 = 60;

/** Maximum number of established connections with a single peer ID */
const MAX_ESTABLISHED_CONNECTIONS_PER_PEER: u32 = 10;
...
const PEER_STORE_RECORD_CAPACITY: usize = 30 * 1024;
